...
import '@/app/contest/football/[matchId]/dataTable.scss';
import type { GetSingleMatchResponse } from 'data-center';
import { getMatchDetail } from 'data-center';
import LiveBox from '@/app/contest/football/[matchId]/liveBox';
import GuessBar from '@/app/contest/football/[matchId]/guessBar';
import TabBar from '@/app/contest/football/[matchId]/tabBar';
import OddMqttService from '@/app/contest/football/[matchId]/oddMqttService';
