...
interface InitState {
    awayRecordData: FormatRecordDataResponse;
}

interface AwayRecordState extends InitState {
    list: BattleRecord[];
...
let useAwayRecordStore: StoreWithSelectors<AwayRecordState>;

const initialState = (set: (data: Partial<AwayRecordState>) => void) => ({
    awayRecordData: {} as FormatRecordDataResponse,
    list: [],
    ...
    setAwayRecordData: (awayRecordData: FormatRecordDataResponse) => {
        set({ awayRecordData });
    },
...
const createAwayRecordStore = (init: InitState) =>
    (useAwayRecordStore = initStore<AwayRecordState>(initialState, init));

export { createAwayRecordStore, useAwayRecordStore };
