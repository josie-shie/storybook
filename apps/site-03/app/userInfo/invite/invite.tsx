            ...
            <div className={style.invite}>
                <div className={style.bounsArea}>
                    ...
                    <div className={style.title}>
                        ...
                        <span>多邀多得無上限</span>
                        <span>
                            每邀請一人，最高獲得<span className={style.money}>88元</span>現金紅包
                        </span>
                    </div>
                    <div className={style.success}>
                        <div className={style.item}>
                            <span>成功邀请</span>
                            <span>
                                <span className={style.number}>10</span>人
                            </span>
                        </div>
                        <div className={style.item}>
                            <span>累积获得</span>
                            <span>
                                <span className={style.number}>200</span>金币
                            </span>
                        </div>
                    </div>
                    <div className={style.copy}>复制邀请连结</div>
                    <div className={style.text}>请使用连结邀请朋友注册，更改连结将导致邀请失效</div>
                </div>
